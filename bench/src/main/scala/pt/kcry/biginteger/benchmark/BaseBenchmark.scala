...
import pt.kcry.biginteger.benchmark.original.java.{BigInteger => jBigInteger}
import pt.kcry.biginteger.benchmark.original.scalajs.{BigInteger => sBigInteger}
import pt.kcry.biginteger.{BigInteger => kBigInteger}
