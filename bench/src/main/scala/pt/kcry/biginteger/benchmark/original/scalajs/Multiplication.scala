...
package pt.kcry.biginteger.benchmark.original.scalajs

import scala.annotation.tailrec

/** Object that provides all multiplication of {@link BigInteger} methods. */
private[biginteger] object Multiplication {
   ...
   */
  private[biginteger] val BigTenPows = new Array[BigInteger](32)
   ...
   *  ({@code 5^0,5^1,...,5^31})
   */
  private[biginteger] val BigFivePows = new Array[BigInteger](32)
